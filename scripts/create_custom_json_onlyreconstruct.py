...
def process_protein(args):
    ...
    reconstruct_protein(mhc = mhcA, tra = traA, trb=trbA, row = row, output_path = output_path, folder_name = "json_unpaired_nopaired_onquerytemplate", description = description)
