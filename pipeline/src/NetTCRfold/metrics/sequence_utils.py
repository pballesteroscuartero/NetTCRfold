...
def get_cdr_from_sequence(sequence, cdr) -> tuple:
    ...
    cdr_indices = list(range(cdr_start_idx, cdr_start_idx + len(cdr_sequence))) #This returns a positional index starting from 0 of the residues in the chain that one should keep
